...
export type Chart = Seat[][];

export const testInput: Chart = `L.LL.LL.LL
LLLLLLL.LL
L.L.L..L..
LLLL.LL.LL
L.LL.LL.LL
...
L.LLLLL.LL`
  .split('\n')
  .map(row => row.split('') as Seat[]);

export const input: Chart = `LLLLLLLLLL.LLLLLL.LLLLLLLLLLLL.LL.LLLL.LLLLL.LLLLLLL.LLLLLL.LLLLLL.LLLLLL.LLLLLLLLLLLLLLLLLL
